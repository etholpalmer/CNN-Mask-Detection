...
mdl_details 	= f"epochs-{args['epochs']}_batch-{args['batchsize']}_basemodel-{args['basemodel']}_learnrate-{args['learnrate']}"
args["plot"]    = f"./Results/plot_{mdl_details}.png"
args["model"]	= f"./models/mask_detector_{mdl_details}.model"
